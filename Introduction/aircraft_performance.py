# Daehyun Jung 
# This is my attempt to apply my engineering knowledge and Python skills to an aerospace application.
# For my first project, I will create a program that takes in aircraft performance variables to calculate the overall performance of an aircraft.
...
def calculate_range(fuel_capacity, fuel_consumption_rate, true_speed):
    range_in_hours = fuel_capacity / fuel_consumption_rate
    range_in_miles = range_in_hours * true_speed
...
# Sace Performance Values into Text File
...
with open('aircraft_performace.txt', 'w') as f:
    save_info_to_file(range, endurance, total_weight, cg_position, lift, drag, weight, acceleration, velocity, distance, file=f)



# This project helps me deepen my understanding of fundamental engineering concepts related to aircraft and apply them by using Python to develop a simple performance calculator. 
# It serves as a solid foundation, combining core engineering principles with practical Python programming skills, offering a comprehensive learning experience.